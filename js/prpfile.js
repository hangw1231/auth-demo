...
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    userLastLogin.textContent = lastLoginDate.toLocaleDateString("ko-KR", {
      year: "numeric",
      month: "long",
      day: "numeric",
      hour: "2-digit",
    ...
    userVerified.textContent = user.emailVerified ? "인증됨" : "인증 필요";
    userVerified.className = user.emailVerified
      ? "ml-2 text-green-600"
      : "ml-2 text-red-600";
  } else {
    alert("로그인이 필요합니다.");
